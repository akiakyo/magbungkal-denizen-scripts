DiscordPlayerReportDiscordEmbedData:
    ...
    messages:
      report-message:
        title: Player Report
        description: <n>**Player Name:** <[args].get[1]><n>**Reason:** <[raw.args]><n><n>**Date:** <util.time_now.to_zone[+8].format_discord><n>
...
DiscordPlayerReportCommand:
    ...
    script:
      ...
      - else:
        ...
        - define staff_ping <discord_role[magbungkal,1142516104518967397,1267532074970255462].mention>
        - ~discordmessage id:magbungkal channel:1266826172004700270 content:<[staff_ping]>
        - wait 1t
...
DiscordBugReportDiscordEmbedData:
    ...
    messages:
      bug-message:
        title: Bug Report
        description: <n>**Bug:** <[args].get[1]><n><n>**How to reproduce:** <[raw.args]><n>**Date:** <util.time_now.to_zone[+8].format_discord><n>
...
DiscordBugReportCommand:
    ...
    script:
      ...
      - else:
         ...
         - define staff_ping <discord_role[magbungkal,1142516104518967397,1267531998960816362].mention>
         - ~discordmessage id:magbungkal channel:1266835691359436800 content:<[staff_ping]>
         - wait 1t
