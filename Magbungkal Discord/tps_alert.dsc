    ...
    events:
        ...
        - if <server.recent_tps.first.round_to_precision[0.05]> < 17:
           ...
           - definemap embed_map:
                ...
                # title:
                color: red
                description: Pinging @Staff Team<n>Can't keep up! Is the server overloaded? Running <server.recent_tps.first.round_to_precision[0.05]> tick per seconds behind.
