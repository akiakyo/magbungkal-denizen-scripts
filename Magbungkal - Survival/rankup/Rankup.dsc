rankup_command:
    ...
    - define req_details "<&nl>   <green><bold>ʀᴀɴᴋᴜᴘ ᴅᴇᴛᴀɪʟꜱ:<&nl><white>   • ᴄᴜʀʀᴇɴᴛ ʀᴀɴᴋ: <green><[rank]> <&nl><white>   • ɴᴇxᴛ ʀᴀɴᴋ: <green><[next_rank]> <&nl><white>   • ʀᴀɴᴋᴜᴘ ʀᴇǫᴜɪʀᴇᴍᴇɴᴛꜱ:"
    ...
    - if !<[ready_for_rankup]>:
        - narrate "<[req_details]><&nl><red>[Rankup] You do not meet the requirements to rankup!"
        - stop

    # commence rankup
    - if <player.has_flag[rankup.confirm]>:
        - narrate "<green>[Rankup] Rankup confirmed!"
    ...
    - narrate "<green>[Rankup] You meet the requirements to rankup to <bold><[next_rank]>!"
    - narrate "<green>[Rankup] Use /rankup again to confirm"
