halloween_2024_leggings:
    type: item
    material: leather_leggings
    display name: <&gradient[from=#D2D2D2;to=#8D8D8D]>☠ Leggings of the Twilight Stalker ☠
    enchantments:
    - protection: 10
    mechanisms:
         unbreakable: true
    ...
    lore:
    - <empty>
    -   <&gradient[from=#D2D2D2;to=#D2D2D2]>Sleek, lightweight leggings made from a fabric that shifts colors in the dark.
    - <empty>
