halloween_2024_boots:
    type: item
    material: leather_boots
    display name: <&gradient[from=#D2D2D2;to=#8D8D8D]>☠ Boots of the Phantom Wanderer ☠
    enchantments:
    - protection: 10
    mechanisms:
         unbreakable: true
    ...
    lore:
    - <empty>
    -   <&gradient[from=#D2D2D2;to=#D2D2D2]>Ethereal boots that allow the wearer to traverse any terrain with ease.
    - <empty>
